...
namespace pixel_renderer
{
    public static class IO
    {
        ...
        public static T? ReadJson<T>(Metadata meta, bool closeStreamWhenFinished = true, StreamReader? outreader = null) where T : new()
        {
            T? obj = new();
            ...
            if (closeStreamWhenFinished)
                reader.Close();
            else if (outreader != null) outreader = reader;
        ...
        public static MessageBoxResult FileOverrideWarning(string path) => MessageBox.Show($"Are you sure you want to overwrite {path}?", "", MessageBoxButton.YesNoCancel, MessageBoxImage.Warning, MessageBoxResult.No, MessageBoxOptions.RtlReading);
        public static MessageBoxResult QuestionBox(string question) => MessageBox.Show(question, "", MessageBoxButton.YesNo, MessageBoxImage.Question, MessageBoxResult.No, MessageBoxOptions.RtlReading);
